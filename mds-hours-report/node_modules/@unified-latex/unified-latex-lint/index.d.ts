...
export declare const lints: {
    ...
    unifiedLatexLintObsoletePackages: import('unified').Plugin<[unknown] | void[], import('@unified-latex/unified-latex-types').Root, import('@unified-latex/unified-latex-types').Root>;
